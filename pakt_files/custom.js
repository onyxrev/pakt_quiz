...
function pdpHeightMatch() {
	var viewportWidth = $(window).width();
	if (viewportWidth > 748) {
		$(".flickity-gallery").matchHeight({
...
function carouselReady() {
	$(".flickity-product").flickity("resize");
	$(".flickity-nav").flickity("resize");
	$(".flickity-showcase").flickity("resize");
	$(".timeline-gallery-1").flickity("resize");
	$(".timeline-gallery-2").flickity("resize");
	$(".timeline-gallery-3").flickity("resize");
	$(".timeline-nav-1").flickity("resize");
	$(".timeline-nav-2").flickity("resize");
	$(".timeline-nav-3").flickity("resize");

	$(".flickity-product").css("opacity", 1);
	$(".flickity-nav").css("opacity", 1);
	$(".timeline-gallery-1").css("opacity", 1);
	$(".timeline-gallery-2").css("opacity", 1);
	$(".timeline-gallery-3").css("opacity", 1);
	$(".timeline-nav-1").css("opacity", 1);
	$(".timeline-nav-2").css("opacity", 1);
	$(".timeline-nav-3").css("opacity", 1);

	$(".flickity-gallery").css("background-image", "none");
	$(".flickity-timeline").css("background-image", "none");
}

function carouselProduct() {
	$(".flickity-product").flickity({
		lazyload: true,
		pageDots: false,
...
function carouselTimeline() {
	...
	$(".timeline-nav-1").flickity({
		asNavFor: ".timeline-gallery-1",
		contain: true,
		cellAlign: "left",
		pageDots: false,
		prevNextButtons: false,
	...
	$(".timeline-nav-2").flickity({
		asNavFor: ".timeline-gallery-2",
		contain: true,
		cellAlign: "left",
		pageDots: false,
		prevNextButtons: false,
	...
	$(".timeline-nav-3").flickity({
		asNavFor: ".timeline-gallery-3",
		contain: true,
		cellAlign: "left",
		pageDots: false,
		prevNextButtons: false,
